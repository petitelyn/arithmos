...
R 3.0, Shiny Server, PostgreSQL, and all packages listed in [requirements](#requirements) must be installed in order to run the application. A PostgreSQL database with the specs found in connectDatabase of complexDatabaseCommunication.R must be created.
